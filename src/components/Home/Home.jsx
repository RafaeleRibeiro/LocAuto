...
const HomePage = () => {
  ...
  useEffect(() => {
    const fetchVeiculos = async () => {
      try {
        ...
        setError(
          "Falha ao carregar os veículos. Por favor, tente novamente mais tarde."
        );
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setError(
        "Erro ao cadastrar o veículo. Por favor, tente novamente mais tarde."
      );
    }
  };
  ...
  const handleLocacao = async (veiculoId, dias) => {
    try {
      ...
      setError(
        "Erro ao realizar a locação. Por favor, tente novamente mais tarde."
      );
    }
  };
  ...
  return (
    <Container fluid className="bg-white min-vh-100 w-100 m-0 p-0">
      <header className="py-3 mb-4 border-bottom ">
        <div className="row w-100">
          <h1 id="titulo" className="col ms-5 ps-5 text-center">
            LOCAUTO
          </h1>
          <Link to="/Cadastro" className="col-1">
            ...
            <Col key={veiculo.id}>
              <Card className="h-100 shadow-sm">
                <Card.Img
                  variant="top"
                  src={
                    veiculo.imagemUrl || "/placeholder.svg?height=180&width=286"
                  }
                  alt={veiculo.modelo}
                />
                <Card.Body className="d-flex flex-column">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      handleLocacao(veiculo.id /* quantidade de dias */)
                    } // Chame handleLocacao com a quantidade de dias desejada
                  >
